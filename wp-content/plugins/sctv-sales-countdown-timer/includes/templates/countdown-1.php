...
$template_1_time_unit_position = $settings->get_current_countdown( 'sale_countdown_template_1_time_unit_position', $index );
$unit_pos_is_top = $template_1_time_unit_position === 'top';
